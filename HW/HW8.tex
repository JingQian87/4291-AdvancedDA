...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{plot}\NormalTok{(kmA}\OperatorTok{$}\NormalTok{time, kmA}\OperatorTok{$}\NormalTok{surv, }\DataTypeTok{type=}\StringTok{"s"}\NormalTok{, }\DataTypeTok{col=}\StringTok{'blue'}\NormalTok{,}\DataTypeTok{xlab=}\StringTok{"Time"}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{"Survival"}\NormalTok{)}
\KeywordTok{lines}\NormalTok{(kmB}\OperatorTok{$}\NormalTok{time, kmB}\OperatorTok{$}\NormalTok{surv)}
\KeywordTok{legend}\NormalTok{(}\DecValTok{20}\NormalTok{, }\FloatTok{0.9}\NormalTok{, }\DataTypeTok{legend=}\KeywordTok{c}\NormalTok{(}\StringTok{"Group A"}\NormalTok{, }\StringTok{"Group B"}\NormalTok{), }\DataTypeTok{col=}\KeywordTok{c}\NormalTok{(}\StringTok{"black"}\NormalTok{, }\StringTok{"blue"}\NormalTok{), }\DataTypeTok{lty=}\DecValTok{1}\OperatorTok{:}\DecValTok{1}\NormalTok{, }\DataTypeTok{cex=}\FloatTok{0.8}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{HW8_files/figure-latex/unnamed-chunk-4-1.pdf} From
